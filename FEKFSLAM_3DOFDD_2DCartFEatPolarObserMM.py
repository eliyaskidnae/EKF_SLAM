...
class FEKFSLAM_3DOFDDInputDisplacementMM_2DCartesianFeaturePolarObservedOM(Cartesian2DStoredPolarObservedMapFeature, FEKFSLAM, EKF_3DOFDifferentialDriveInputDisplacement):
    """
...
if __name__ == '__main__':
    ...
    Rfc = np.diag(np.array([0.02** 2,0.002** 2])) 
