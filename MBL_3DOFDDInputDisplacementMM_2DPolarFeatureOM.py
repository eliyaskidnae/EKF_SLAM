...
if __name__ == '__main__':
    M = [    PolarFeature(c2p(CartesianFeature(np.array([[-40, 5]]).T))),
             PolarFeature(c2p(CartesianFeature(np.array([[-5, 40]]).T))),
             PolarFeature(c2p(CartesianFeature(np.array([[-5, 25]]).T))),
             PolarFeature(c2p(CartesianFeature(np.array([[-3, 50]]).T))),
             PolarFeature(c2p(CartesianFeature(np.array([[-20, 3]]).T))),
             PolarFeature(c2p(CartesianFeature(np.array([[40, -40]]).T)))
